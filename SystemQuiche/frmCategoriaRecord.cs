...
namespace SystemQuiche{
    public partial class frmCategoriaRecord : Form
    {
        ...
        private void dataGridView1_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
            ...
            if (dataGridView.RowHeadersWidth < Convert.ToInt32((size.Width + 20)))
            {
                dataGridView.RowHeadersWidth = Convert.ToInt32((size.Width + 20));
            }
        ...
        private void dataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            this.Hide();
            frmCategoria frm = new frmCategoria();
            frm.txtNomeCategoria.Text = (dataGridView.CurrentRow.Cells[1].Value.ToString());
